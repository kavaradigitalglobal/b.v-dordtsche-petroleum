...
export const Route = createFileRoute("/services/")({
  head: () => ({
    meta: [
      { title: "Refined Petroleum Products & Services | FOB Supply" },
      {
        name: "description",
        content:
          "D2 gas oil, ULSD 10/15 PPM, biodiesel B100, residual fuel oil, AVGAS, JET A-1 kerosene and marine diesel oil supplied on FOB terms, SGS inspected.",
      },
      { property: "og:title", content: "Refined Petroleum Products & Services | FOB Supply" },
      {
        property: "og:description",
        content:
          "Seven refined grades available on contract terms and immediate trial shipment, delivered FOB worldwide.",
      },
